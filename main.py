...
from modules.meal_tracking.nutrition_router import router as nutrition_router
...
from modules.rehab_tracking.router import router as rehab_tracking_router
...
app.include_router(rehab_tracking_router)
